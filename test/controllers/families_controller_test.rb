...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { bride_id: @family.bride_id, category: @family.category, groom_id: @family.groom_id } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { bride_id: @family.bride_id, category: @family.category, groom_id: @family.groom_id } }
